    ...
    <div className="">
      ...
      <div className="text-center w-full h-24 flex items-center justify-center">
        <div className="w-full px-10 flex sm:flex-row flex-col items-center justify-between">
          ...
          <Tooltip title="Search by month" placement="top">
            <input
              type="month"
              placeholder="Select Your Month"
              className="bg-mildgray h-12 rounded text-white px-3 md:px-7 lg:mx-7 custom-input"
            />
          </Tooltip>
      ...
      <div className="grid lg:grid-cols-4 xl:place-items-center md:grid-cols-3 sm:grid-cols-2 lg:gap-x-1 gap-x-3 gap-y-5 grid-cols-1 p-3 py-10 pb-40 sm:pb-10">
        <div className="lg:w-62 xl:w-72 h-40 bg-mildgray col-span-1 rounded-sm shadow p-5 relative transition duration-500 transform hover:-rotate-3">
          <h1 className="text-2xl">21-10-2020</h1>
          <p className="text-xs mt-1 text-darkgray mb-4">Written at 06:30 PM</p>
